...
class Admin extends Account{
    ...
    banUser(userAcc : UserAcc){
        userAcc.status = "banned";
        console.log(`tai khoan ${userAcc.userName} bi ban`);
...
console.log(userAcc1.status);

let adminAcc1 = new Admin("123456789", "Admin", "123456", false, "admin");
// adminAcc1.login();
adminAcc1.banUser(userAcc1);
console.log(userAcc1.status);
